	...
	sites				: [ // List of sites to monitor
		{
			...
			endpoints		: [ // Each site is a bunch of endpoints that can be tested
				...
				{
					id				: 'vencloud', // optional
					name			: 'Vencloud', // optional
					link			: 'https://vencloud.marcus7i.net', // optional, for notifications and dashboard only, [defaults to endpoint.url], can be disabled by setting it to false
					url				: 'https://vencloud.marcus7i.net', // required
					request			: { // optional, fetch options
						method: 'GET',
					},
					mustFind		: '', // optional, String | Array | Regex | Function | AsyncFunction
